...
type AppointmentUsecase interface {
	...
	GetByDoctor(ctx context.Context, doctorID uuid.UUID, page string, limit string) (dto.AppointmentResponse, error)
	GetByPatient(ctx context.Context, patientID uuid.UUID, page string, limit string) (dto.AppointmentResponse, error)
